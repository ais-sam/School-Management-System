  ...
  return (
    <div className="py-10 flex items-center justify-between">
          <div className="flex gap-10 items-center flex-grow">
            <input id="base" type="text" name="name" className="h-11 rounded-sm border-none bg-[#dddeee7c] placeholder:text-[#757576] placeholder:text-sm w-72" placeholder={`${type==="subjects" ? 'Search by subject name...':'Search by name...'}`}/>
